...
if __name__ == '__main__':
    ...
    readInfo("three.all.vcf.2.TRA.info")    #readInfo("three.all.vcf.infoi")
    ...
    #evaluationSV("three.all.vcf.2.info","/public3/SVDataset_lz/backup/2023_11_14/SV_static/SV_new")
