...
if __name__ == '__main__':
    ...
    readInfo("three.all.vcf.info")    #readInfo("three.all.vcf.infoi")
    ...
    #evaluationSV("three.minimap2.500.vcf.info","/public3/SVDataset_lz/backup/2023_11_14/SV_static/SV_new")
