...
def modify_file(vcffile):
    ...
    dup_vcffile_tmp = vcffile.replace("/INS/","/DUP/")
    dup_vcffile = dup_vcffile_tmp.replace("real_INS.vcf","real_DUP.vcf")
    ...
    out_vcffile_tmp = vcffile.replace("/INS/","/DUP_INS/")
    out_vcffile     = out_vcffile_tmp.replace("real_INS.vcf","real_DUP_INS.vcf")
...
if __name__ == "__main__":
    folder_path = '/public3/SVDataset_lz/backup/2023_11_14/SV_static/SV_sim/SimOutPath'
