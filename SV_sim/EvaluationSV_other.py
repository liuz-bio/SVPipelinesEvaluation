...
class EvaluationSV():
    def __init__(self, VcfBaseFile=None, VcfCommFile=None, svType=None, outFile=None, RE_nu= None, nux = None):
         ...
         self.TP_GT_comm = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.TP_no_GT_comm = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.TP_GT_base = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.TP_no_GT_base = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.lsv_GT = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.bc1_GT = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.bc2_GT = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.lsv_no_GT = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.bc1_no_GT = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         self.bc2_no_GT = {'0-100':[],'100-500':[],'500-1000':[],'1000-2500':[],'2500-99999999999':[]}
         ...
         bedDicts = {'BND':"/home/lz/Data_sequence/2021_4_2/SV_static/SV_sim/bed/BND.bed",
                     ...
                     'DEL':"/home/lz/Data_sequence/2021_4_2/SV_static/SV_new/SV_HG002/bed/DEL.HG002.bed",
                     'INS':"/home/lz/Data_sequence/2021_4_2/SV_static/SV_sim/bed/INS.bed",
                     'INV':"/home/lz/Data_sequence/2021_4_2/SV_static/SV_sim/bed/INV.bed",
                     'DUP':"/home/lz/Data_sequence/2021_4_2/SV_static/SV_new/SV_HG002/bed/DUP.HG002.bed"}
    ...
    def bedPass(self, line ):
        ...
        if chr2 == "None":
            for lx in chridList:
                if (lx[0] <= int(line[1]) <= lx[1]) or (lx[0] <= int(line[2]) <= lx[1]):
                    return True
        else:
            try:
            ...
            for lx in chridList:
                for lxx in chridList2:
                    if lx[0] <= int(line[1]) <= lx[1] or lxx[0] <= int(line[2]) <= lxx[1]:
                        return True
    ...
    def readvcf(self, VcfFile):
        ...
        lineSize = 0
        vcfLines = []
        tmpDict = {'0-100':0,'100-500':0,'500-1000':0,'1000-2500':0,'2500-99999999999':0}
        nnuu = 0
        nnuuDict = {}
    ...
    def del_ins_inv_dup(self, vcfbaseline, vcfcommline):
        Result = False
        tmp = ['0-100','100-500','500-1000','1000-2500','2500-99999999999']
    ...
    def F1_recall_precision(self):
        ...
        for k in self.TP_no_GT_comm.keys():
            ...
            try:
                precision_no_GT = self.oneselcet(commNGT/self.lencomm[k])
                recall_no_GT =  self.oneselcet(baseNGT/self.lenbase[k])
                F1_no_GT = 2*precision_no_GT*recall_no_GT/(precision_no_GT+recall_no_GT)
            except ZeroDivisionError:
                precision_no_GT,recall_no_GT,F1_no_GT = 0,0,0
            #print(precision_no_GT,recall_no_GT,F1_no_GT)
            #6072 6030 6630 6679
            print(commNGT,baseNGT,self.lencomm[k],self.lenbase[k])
